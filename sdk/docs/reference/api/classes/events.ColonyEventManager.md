...
As opposed to the [ColonyNetwork.ColonyNetwork](ColonyNetwork.ColonyNetwork.md) class, this constructor _needs_ an _ethers_ JsonRpcProvider (or a subclass of it) as it's

...
Alternatively, you can use [npx](https://www.npmjs.com/package/npx) and kickstart the `colony-starter` package in one line without having to globally add the [colony-starter](/colonystarter/starters-colony-starter/) package:

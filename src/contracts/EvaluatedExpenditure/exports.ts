...
import type { EvaluatedExpenditure as EvaluatedExpenditure4 } from './4';
import type { EvaluatedExpenditure as EvaluatedExpenditure5 } from './5';

// Always adjust to the latest factory
export { EvaluatedExpenditure__factory as EvaluatedExpenditureFactory } from './5/factories/EvaluatedExpenditure__factory';

...
interface IMetaColonyInterface extends Interface {
  ...
  events: {
    ...
    ColonyFundingRoleSet: TypedEventDescription<{
      encodeTopics([user, setTo]: [null, null]): string[];
    }>;

    ColonyAdministrationRoleSet: TypedEventDescription<{
      encodeTopics([user, setTo]: [null, null]): string[];
    }>;

    ColonyArchitectureRoleSet: TypedEventDescription<{
      encodeTopics([user, setTo]: [null, null]): string[];
    }>;

    ColonyRootRoleSet: TypedEventDescription<{
      encodeTopics([user, setTo]: [null, null]): string[];
    }>;
...
export class IMetaColony extends Contract {
  ...
  functions: {
    ...
    /**
     * Calls `IColonyNetwork.deprecateSkill`
    ...
    /**
     * Calls `IColonyNetwork.setFeeInverse`
    ...
    /**
     * Calls `IColonyNetwork.addColonyVersion`

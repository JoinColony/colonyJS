...
export class IReputationMiningCycle extends Contract {
  ...
  functions: {
     ...
     * @returns An array of DisputedEntrys struct for the round. See ReputationMiningCycleDataTypes for the full description of the properties.
     */
    getDisputeRound(
      _round: BigNumberish
    ): Promise<
    ...
    /**
     * Only callable by colonyNetworkNote that the same address might be present multiple times in `stakers` - this is acceptable, and indicates the same address backed the same hash multiple times with different entries.

...
export type StakeTransferredEvent = TypedEvent<
  ...
  { token: string; by: string; from: string; to: string; amount: BigNumber }
>;
...
export type TokenLockedEvent = TypedEvent<
  ...
  { token: string; lockedBy: string; lockCount: BigNumber }
>;
...
export type UserTokenApprovedEvent = TypedEvent<
  ...
  { token: string; user: string; approvedBy: string; amount: BigNumber }
>;
...
export type UserTokenDeobligatedEvent = TypedEvent<
  [string, string, string, BigNumber],
  { token: string; user: string; obligatedBy: string; amount: BigNumber }
>;
...
export type UserTokenTransferredEvent = TypedEvent<
  [string, string, string, BigNumber],
  { token: string; user: string; recipient: string; amount: BigNumber }
>;
...
export type UserTokenUnlockedEvent = TypedEvent<
  [string, string, BigNumber],
  { token: string; user: string; lockId: BigNumber }
>;

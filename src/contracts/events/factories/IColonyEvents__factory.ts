...
import type { IColonyEvents, IColonyEventsInterface } from "../IColonyEvents";
...
export class IColonyEvents__factory {
  ...
  static createInterface(): IColonyEventsInterface {
    return new utils.Interface(_abi) as IColonyEventsInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IColonyEvents {
    return new Contract(address, _abi, signerOrProvider) as IColonyEvents;
  }
}

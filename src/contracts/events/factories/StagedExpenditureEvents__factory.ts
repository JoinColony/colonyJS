...
export class StagedExpenditureEvents__factory {
  ...
  static createInterface(): StagedExpenditureEventsInterface {
    return new utils.Interface(_abi) as StagedExpenditureEventsInterface;
  }
  static connect(
    address: string,

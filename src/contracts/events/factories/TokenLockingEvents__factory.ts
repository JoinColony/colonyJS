...
export class TokenLockingEvents__factory {
  ...
  static createInterface(): TokenLockingEventsInterface {
    return new utils.Interface(_abi) as TokenLockingEventsInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): TokenLockingEvents {
    return new Contract(address, _abi, signerOrProvider) as TokenLockingEvents;
  }
}

...
export declare namespace FundingQueue {
  export type ProposalStruct = {
    ...
    domainTotalRep: BigNumberish;
    fromPot: BigNumberish;
    toPot: BigNumberish;
    fromChildSkillIndex: BigNumberish;
    toChildSkillIndex: BigNumberish;
    totalRequested: BigNumberish;
    totalPaid: BigNumberish;
    lastUpdated: BigNumberish;
    totalSupport: BigNumberish;
  };
...
export interface FundingQueue extends BaseContract {
  ...
  functions: {
    ...
    backProposal(
      _id: BigNumberish,
      _backing: BigNumberish,
      _currPrevId: BigNumberish,
      _newPrevId: BigNumberish,
      _key: BytesLike,
      _value: BytesLike,
      _branchMask: BigNumberish,
      _siblings: BytesLike[],
  ...
  callStatic: {
     ...
     * @param _id The proposal Id
     */
    pingProposal(_id: BigNumberish, overrides?: CallOverrides): Promise<void>;

    /**
     * Reclaim the stake after the proposal is funded
     * @param _id The proposal Id
     */
    reclaimStake(_id: BigNumberish, overrides?: CallOverrides): Promise<void>;

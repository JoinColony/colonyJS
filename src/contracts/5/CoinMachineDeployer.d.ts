...
interface CoinMachineDeployerInterface extends Interface {
  functions: {
...
export class CoinMachineDeployer extends Contract {
  connect(signerOrProvider: Signer | Provider | string): CoinMachineDeployer;
  attach(addressOrName: string): CoinMachineDeployer;
  deployed(): Promise<CoinMachineDeployer>;

  on(event: EventFilter | string, listener: Listener): CoinMachineDeployer;
  once(event: EventFilter | string, listener: Listener): CoinMachineDeployer;
  addListener(
    eventName: EventFilter | string,
    listener: Listener
  ): CoinMachineDeployer;
  removeAllListeners(eventName: EventFilter | string): CoinMachineDeployer;
  removeListener(eventName: any, listener: Listener): CoinMachineDeployer;

  interface: CoinMachineDeployerInterface;

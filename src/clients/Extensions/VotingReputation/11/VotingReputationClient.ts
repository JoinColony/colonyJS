/*
 * VotingReputation Client Version 11 autogenerated by
...
import { VotingReputation__factory as VotingReputationFactory } from '../../../../contracts/extensions/votingReputation/11/factories/VotingReputation__factory';
import { VotingReputation } from '../../../../contracts/extensions/votingReputation/11/VotingReputation';
...
import { VotingReputationClient as VotingReputationClient9 } from '../9/VotingReputationClient';
import { VotingReputationClient as VotingReputationClient10 } from '../10/VotingReputationClient';
...
import * as version9Addons from '../9/VotingReputationClientAddons';
import * as version10Addons from '../10/VotingReputationClientAddons';
...
import * as version9EncodedInterfaces from '../9/VotingReputationClientEncodeInterfaces';
import * as version10EncodedInterfaces from '../10/VotingReputationClientEncodeInterfaces';
...
const getVotingReputationClient = (
  ...
  const addons = {
    ...
    ...version9Addons.getVotingReputationClientAddons(
      (votingReputationClient as unknown) as VotingReputationClient9,
      colonyClient,
    ),
    ...version10Addons.getVotingReputationClientAddons(
      (votingReputationClient as unknown) as VotingReputationClient10,
      colonyClient,
    ),
  ...
  const addonsEstimate = {
    ...
    ...version9Addons.getVotingReputationClientEstimateAddons(
      (votingReputationClient as unknown) as VotingReputationClient9,
      colonyClient,
    ),
    ...version10Addons.getVotingReputationClientEstimateAddons(
      (votingReputationClient as unknown) as VotingReputationClient10,
      colonyClient,
    ),
  ...
  const encodedInterfaces = {
    ...
    ...version9EncodedInterfaces.getVotingReputationClientEncodeInterfaces(
      (votingReputationClient as unknown) as VotingReputationClient9,
      colonyClient,
    ),
    ...version10EncodedInterfaces.getVotingReputationClientEncodeInterfaces(
      (votingReputationClient as unknown) as VotingReputationClient10,
      colonyClient,
    ),

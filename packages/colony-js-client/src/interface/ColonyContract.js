...
export interface ColonyContract extends IContract {
  ...
  >;
  moveFundsBetweenPots: SendFn<$PropertyType<sendFns, 'moveFundsBetweenPots'>>;
  revealTaskWorkRating: SendFn<$PropertyType<sendFns, 'revealTaskWorkRating'>>;
  ...
  >;
  setTaskManagerPayout: SendFn<$PropertyType<sendFns, 'setTaskManagerPayout'>>;
  ...
  >;
  submitTaskWorkRating: SendFn<$PropertyType<sendFns, 'submitTaskWorkRating'>>;

# Interface: StreamingPaymentsClientV4
...
| Name | Type |
| :------ | :------ |
| `ClaimWaived` | (`agent?`: ``null``, `streamingPaymentId?`: ``null`` \| `BigNumberish`, `token?`: ``null``) => `ClaimWaivedEventFilter` |
| `ClaimWaived(address,uint256,address)` | (`agent?`: ``null``, `streamingPaymentId?`: ``null`` \| `BigNumberish`, `token?`: ``null``) => `ClaimWaivedEventFilter` |
...
• **off**: `OnEvent`<[`StreamingPaymentsClientV4`](StreamingPaymentsClientV4.md)\>
...
• **on**: `OnEvent`<[`StreamingPaymentsClientV4`](StreamingPaymentsClientV4.md)\>
...
• **once**: `OnEvent`<[`StreamingPaymentsClientV4`](StreamingPaymentsClientV4.md)\>
...
• **removeListener**: `OnEvent`<[`StreamingPaymentsClientV4`](StreamingPaymentsClientV4.md)\>
...
Same as [addToken](StreamingPaymentsClientV4.md#addtoken), but let colonyJS figure out the permission proofs for you.
...
▸ **attach**(`addressOrName`): [`StreamingPaymentsClientV4`](StreamingPaymentsClientV4.md)
...
[`StreamingPaymentsClientV4`](StreamingPaymentsClientV4.md)
...
Same as [cancel](StreamingPaymentsClientV4.md#cancel), but let colonyJS figure out the permission proofs for you.
Always prefer this method, except when you have good reason not to.
...
Same as [claim](StreamingPaymentsClientV4.md#claim), but let colonyJS figure out the permission proofs for you.
Always prefer this method, except when you have good reason not to.
...
▸ **connect**(`signerOrProvider`): [`StreamingPaymentsClientV4`](StreamingPaymentsClientV4.md)
...
Same as [create](StreamingPaymentsClientV4.md#create), but let colonyJS figure out the permission proofs for you.
Always prefer this method, except when you have good reason not to.
...
▸ **deployed**(): `Promise`<[`StreamingPaymentsClientV4`](StreamingPaymentsClientV4.md)\>

#### Returns

`Promise`<[`StreamingPaymentsClientV4`](StreamingPaymentsClientV4.md)\>
...
▸ **removeAllListeners**<`TEvent`\>(`eventFilter`): [`StreamingPaymentsClientV4`](StreamingPaymentsClientV4.md)
...
▸ **removeAllListeners**(`eventName?`): [`StreamingPaymentsClientV4`](StreamingPaymentsClientV4.md)
...
Same as [setEndTime](StreamingPaymentsClientV4.md#setendtime), but let colonyJS figure out the permission proofs for you.
Always prefer this method, except when you have good reason not to.
...
Same as [setStartTime](StreamingPaymentsClientV4.md#setstarttime), but let colonyJS figure out the permission proofs for you.
Always prefer this method, except when you have good reason not to.
...
Same as [setTokenAmount](StreamingPaymentsClientV4.md#settokenamount), but let colonyJS figure out the permission proofs for you.
Always prefer this method, except when you have good reason not to.

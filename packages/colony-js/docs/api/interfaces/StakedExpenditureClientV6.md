...
▸ **attach**(`addressOrName`): [`StakedExpenditureClientV6`](StakedExpenditureClientV6.md)
...
[`StakedExpenditureClientV6`](StakedExpenditureClientV6.md)
...
Same as [cancelAndPunish](StakedExpenditureClientV6.md#cancelandpunish), but let colonyJS figure out the permission proofs for you.
...
Same as [cancelAndReclaimStake](StakedExpenditureClientV6.md#cancelandreclaimstake), but let colonyJS figure out the permission proofs for you.
Always prefer this method, except when you have good reason not to.
...
▸ **connect**(`signerOrProvider`): [`StakedExpenditureClientV6`](StakedExpenditureClientV6.md)
...
Same as [makeExpenditureWithStake](StakedExpenditureClientV6.md#makeexpenditurewithstake), but let colonyJS figure out the permission proofs for you.
Always prefer this method, except when you have good reason not to.
...
▸ **removeAllListeners**<`TEvent`\>(`eventFilter`): [`StakedExpenditureClientV6`](StakedExpenditureClientV6.md)
...
▸ **removeAllListeners**(`eventName?`): [`StakedExpenditureClientV6`](StakedExpenditureClientV6.md)

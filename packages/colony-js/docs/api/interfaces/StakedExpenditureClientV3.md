...
▸ **attach**(`addressOrName`): [`StakedExpenditureClientV3`](StakedExpenditureClientV3.md)
...
[`StakedExpenditureClientV3`](StakedExpenditureClientV3.md)
...
Same as [cancelAndPunish](StakedExpenditureClientV3.md#cancelandpunish), but let colonyJS figure out the permission proofs for you.
...
Same as [cancelAndReclaimStake](StakedExpenditureClientV3.md#cancelandreclaimstake), but let colonyJS figure out the permission proofs for you.
Always prefer this method, except when you have good reason not to.
...
▸ **connect**(`signerOrProvider`): [`StakedExpenditureClientV3`](StakedExpenditureClientV3.md)
...
Same as [makeExpenditureWithStake](StakedExpenditureClientV3.md#makeexpenditurewithstake), but let colonyJS figure out the permission proofs for you.
Always prefer this method, except when you have good reason not to.
...
▸ **removeAllListeners**<`TEvent`\>(`eventFilter`): [`StakedExpenditureClientV3`](StakedExpenditureClientV3.md)
...
▸ **removeAllListeners**(`eventName?`): [`StakedExpenditureClientV3`](StakedExpenditureClientV3.md)

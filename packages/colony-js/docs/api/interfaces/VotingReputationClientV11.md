...
▸ **removeAllListeners**<`TEvent`\>(`eventFilter`): [`VotingReputationClientV11`](VotingReputationClientV11.md)
...
▸ **removeAllListeners**(`eventName?`): [`VotingReputationClientV11`](VotingReputationClientV11.md)
...
Same as [stakeMotion](VotingReputationClientV11.md#stakemotion), but let colonyJS figure out the permission proofs for you.
Always prefer this method, except when you have good reason not to.

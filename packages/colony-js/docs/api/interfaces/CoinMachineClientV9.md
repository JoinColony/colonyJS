...
• **off**: `OnEvent`<[`CoinMachineClientV9`](CoinMachineClientV9.md)\>
...
• **on**: `OnEvent`<[`CoinMachineClientV9`](CoinMachineClientV9.md)\>
...
• **once**: `OnEvent`<[`CoinMachineClientV9`](CoinMachineClientV9.md)\>
...
• **removeListener**: `OnEvent`<[`CoinMachineClientV9`](CoinMachineClientV9.md)\>
...
▸ **attach**(`addressOrName`): [`CoinMachineClientV9`](CoinMachineClientV9.md)
...
[`CoinMachineClientV9`](CoinMachineClientV9.md)
...
▸ **connect**(`signerOrProvider`): [`CoinMachineClientV9`](CoinMachineClientV9.md)
...
▸ **deployed**(): `Promise`<[`CoinMachineClientV9`](CoinMachineClientV9.md)\>

#### Returns

`Promise`<[`CoinMachineClientV9`](CoinMachineClientV9.md)\>
...
▸ **removeAllListeners**<`TEvent`\>(`eventFilter`): [`CoinMachineClientV9`](CoinMachineClientV9.md)
...
▸ **removeAllListeners**(`eventName?`): [`CoinMachineClientV9`](CoinMachineClientV9.md)

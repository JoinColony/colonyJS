...
Same as [cancelAndPunish](StakedExpenditureClientV5.md#cancelandpunish-18), but let colonyJS figure out the permission proofs for you.
...
Same as [cancelAndReclaimStake](StakedExpenditureClientV5.md#cancelandreclaimstake-18), but let colonyJS figure out the permission proofs for you.
Always prefer this method, except when you have good reason not to.
...
Same as [makeExpenditureWithStake](StakedExpenditureClientV5.md#makeexpenditurewithstake-18), but let colonyJS figure out the permission proofs for you.
Always prefer this method, except when you have good reason not to.

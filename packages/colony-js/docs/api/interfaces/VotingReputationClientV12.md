...
▸ **removeAllListeners**<`TEvent`\>(`eventFilter`): [`VotingReputationClientV12`](VotingReputationClientV12.md)
...
▸ **removeAllListeners**(`eventName?`): [`VotingReputationClientV12`](VotingReputationClientV12.md)
...
Same as [stakeMotion](VotingReputationClientV12.md#stakemotion), but let colonyJS figure out the permission proofs for you.
Always prefer this method, except when you have good reason not to.

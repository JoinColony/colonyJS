...
• **off**: `OnEvent`<[`VotingReputationClientV5`](VotingReputationClientV5.md)\>
...
• **on**: `OnEvent`<[`VotingReputationClientV5`](VotingReputationClientV5.md)\>
...
• **once**: `OnEvent`<[`VotingReputationClientV5`](VotingReputationClientV5.md)\>
...
▸ **deployed**(): `Promise`<[`VotingReputationClientV5`](VotingReputationClientV5.md)\>

...
▸ **attach**(`addressOrName`): [`TokenEvents`](TokenEvents.md)
...
▸ **connect**(`signerOrProvider`): [`TokenEvents`](TokenEvents.md)
...
▸ **removeAllListeners**<`TEvent`\>(`eventFilter`): [`TokenEvents`](TokenEvents.md)
...
▸ **removeAllListeners**(`eventName?`): [`TokenEvents`](TokenEvents.md)

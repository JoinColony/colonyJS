...
| `StakeFractionSet(address,uint256)` | (`agent?`: ``null``, `stakeFraction?`: ``null``) => [`StakeFractionSet_address_uint256_EventFilter`](../modules/StakedExpenditureEvents.md#stakefractionset_address_uint256_eventfilter) |

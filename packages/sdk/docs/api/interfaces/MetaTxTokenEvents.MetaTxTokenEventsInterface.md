...
[MetaTxTokenEvents](../modules/MetaTxTokenEvents.md).MetaTxTokenEventsInterface
...
| Name | Type |
| :------ | :------ |
| `nameOrSignatureOrTopic` | ``"Burn(address,uint256)"`` |
...
| Name | Type |
| :------ | :------ |
| `nameOrSignatureOrTopic` | ``"Mint(address,uint256)"`` |

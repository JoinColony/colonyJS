...
[CoinMachineEvents](../modules/CoinMachineEvents.md).CoinMachineEventsInterface
...
| Name | Type |
| :------ | :------ |
| `nameOrSignatureOrTopic` | ``"PeriodUpdated"`` |
...
| Name | Type |
| :------ | :------ |
| `nameOrSignatureOrTopic` | ``"PeriodUpdated(uint256,uint256)"`` |
...
| Name | Type |
| :------ | :------ |
| `nameOrSignatureOrTopic` | ``"PriceEvolutionSet"`` |
...
| Name | Type |
| :------ | :------ |
| `nameOrSignatureOrTopic` | ``"PriceEvolutionSet(bool)"`` |
...
| Name | Type |
| :------ | :------ |
| `nameOrSignatureOrTopic` | ``"WhitelistSet"`` |
...
| Name | Type |
| :------ | :------ |
| `nameOrSignatureOrTopic` | ``"WhitelistSet(address)"`` |

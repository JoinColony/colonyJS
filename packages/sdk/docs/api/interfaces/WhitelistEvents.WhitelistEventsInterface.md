...
[WhitelistEvents](../modules/WhitelistEvents.md).WhitelistEventsInterface
...
| Name | Type |
| :------ | :------ |
| `nameOrSignatureOrTopic` | ``"AgreementSigned"`` |
...
| Name | Type |
| :------ | :------ |
| `nameOrSignatureOrTopic` | ``"AgreementSigned(address)"`` |
...
| Name | Type |
| :------ | :------ |
| `nameOrSignatureOrTopic` | ``"UserApproved"`` |
...
| Name | Type |
| :------ | :------ |
| `nameOrSignatureOrTopic` | ``"UserApproved(address,bool)"`` |

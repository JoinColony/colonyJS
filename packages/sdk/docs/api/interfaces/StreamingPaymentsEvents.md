...
▸ **attach**(`addressOrName`): [`StreamingPaymentsEvents`](StreamingPaymentsEvents.md)
...
[`StreamingPaymentsEvents`](StreamingPaymentsEvents.md)
...
▸ **connect**(`signerOrProvider`): [`StreamingPaymentsEvents`](StreamingPaymentsEvents.md)
...
▸ **removeAllListeners**<`TEvent`\>(`eventFilter`): [`StreamingPaymentsEvents`](StreamingPaymentsEvents.md)
...
▸ **removeAllListeners**(`eventName?`): [`StreamingPaymentsEvents`](StreamingPaymentsEvents.md)

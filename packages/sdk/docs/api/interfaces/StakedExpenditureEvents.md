...
▸ **attach**(`addressOrName`): [`StakedExpenditureEvents`](StakedExpenditureEvents.md)
...
[`StakedExpenditureEvents`](StakedExpenditureEvents.md)
...
▸ **connect**(`signerOrProvider`): [`StakedExpenditureEvents`](StakedExpenditureEvents.md)
...
▸ **removeAllListeners**<`TEvent`\>(`eventFilter`): [`StakedExpenditureEvents`](StakedExpenditureEvents.md)
...
▸ **removeAllListeners**(`eventName?`): [`StakedExpenditureEvents`](StakedExpenditureEvents.md)

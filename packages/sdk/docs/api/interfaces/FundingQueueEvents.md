...
| `ProposalCreated(uint256,uint256,uint256,address,uint256)` | (`id?`: ``null``, `fromPot?`: ``null`` \| `BigNumberish`, `toPot?`: ``null`` \| `BigNumberish`, `token?`: ``null`` \| `string`, `amount?`: ``null``) => `ProposalCreatedEventFilter` |

...
[OneTxPaymentEvents](../modules/OneTxPaymentEvents.md).OneTxPaymentEventsInterface
...
| Name | Type |
| :------ | :------ |
| `nameOrSignatureOrTopic` | ``"OneTxPaymentMade"`` |
...
| Name | Type |
| :------ | :------ |
| `nameOrSignatureOrTopic` | ``"OneTxPaymentMade(address,uint256,uint256)"`` |

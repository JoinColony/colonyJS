...
[ReputationBootstrapperEvents](../modules/ReputationBootstrapperEvents.md).ReputationBootstrapperEventsInterface
...
| Name | Type |
| :------ | :------ |
| `nameOrSignatureOrTopic` | ``"GrantClaimed"`` |
...
| Name | Type |
| :------ | :------ |
| `nameOrSignatureOrTopic` | ``"GrantClaimed(address,uint256,bool)"`` |
...
| Name | Type |
| :------ | :------ |
| `nameOrSignatureOrTopic` | ``"GrantSet"`` |
...
| Name | Type |
| :------ | :------ |
| `nameOrSignatureOrTopic` | ``"GrantSet(bool,bytes32,uint256)"`` |

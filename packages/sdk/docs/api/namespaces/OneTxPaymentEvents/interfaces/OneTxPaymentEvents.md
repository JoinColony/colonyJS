...
[`OneTxPaymentMadeEventFilter`](../type-aliases/OneTxPaymentMadeEventFilter.md)
...
> **interface**: [`OneTxPaymentEventsInterface`](OneTxPaymentEventsInterface.md)
...
> **off**: `OnEvent`\<[`OneTxPaymentEvents`](OneTxPaymentEvents.md)\>
...
> **on**: `OnEvent`\<[`OneTxPaymentEvents`](OneTxPaymentEvents.md)\>
...
> **once**: `OnEvent`\<[`OneTxPaymentEvents`](OneTxPaymentEvents.md)\>
...
> **removeListener**: `OnEvent`\<[`OneTxPaymentEvents`](OneTxPaymentEvents.md)\>
...
> **deployed**(): `Promise`\<[`OneTxPaymentEvents`](OneTxPaymentEvents.md)\>

#### Returns

`Promise`\<[`OneTxPaymentEvents`](OneTxPaymentEvents.md)\>

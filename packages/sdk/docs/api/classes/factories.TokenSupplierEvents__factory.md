...
[factories](../modules/factories.md).TokenSupplierEvents__factory
...
▸ `Static` **connect**(`address`, `signerOrProvider`): [`TokenSupplierEvents`](../interfaces/TokenSupplierEvents.md)

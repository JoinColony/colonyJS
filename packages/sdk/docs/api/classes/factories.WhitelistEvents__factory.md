...
[factories](../modules/factories.md).WhitelistEvents__factory
...
▸ `Static` **connect**(`address`, `signerOrProvider`): [`WhitelistEvents`](../interfaces/WhitelistEvents.md)
...
▸ `Static` **createInterface**(): [`WhitelistEventsInterface`](../interfaces/WhitelistEventsInterface.md)

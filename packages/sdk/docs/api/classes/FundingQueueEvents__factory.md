...
▸ `Static` **connect**(`address`, `signerOrProvider`): [`FundingQueueEvents`](../interfaces/FundingQueueEvents.FundingQueueEvents.md)
...
▸ `Static` **createInterface**(): [`FundingQueueEventsInterface`](../interfaces/FundingQueueEvents.FundingQueueEventsInterface.md)

...
[factories](../modules/factories.md).OneTxPaymentEvents__factory
...
▸ `Static` **connect**(`address`, `signerOrProvider`): [`OneTxPaymentEvents`](../interfaces/OneTxPaymentEvents.md)
...
▸ `Static` **createInterface**(): [`OneTxPaymentEventsInterface`](../interfaces/OneTxPaymentEventsInterface.md)

[ColonyJS](../README.md) / [Exports](../modules.md) / VotingReputationClientV3
...
- [\_deployedPromise](VotingReputationClientV3.md#_deployedpromise)
- [\_runningEvents](VotingReputationClientV3.md#_runningevents)
- [\_wrappedEmits](VotingReputationClientV3.md#_wrappedemits)
- [address](VotingReputationClientV3.md#address)
- [callStatic](VotingReputationClientV3.md#callstatic)
- [clientType](VotingReputationClientV3.md#clienttype)
- [clientVersion](VotingReputationClientV3.md#clientversion)
- [colonyClient](VotingReputationClientV3.md#colonyclient)
- [deployTransaction](VotingReputationClientV3.md#deploytransaction)
- [estimateGas](VotingReputationClientV3.md#estimategas)
- [filters](VotingReputationClientV3.md#filters)
- [functions](VotingReputationClientV3.md#functions)
- [interface](VotingReputationClientV3.md#interface)
- [off](VotingReputationClientV3.md#off)
- [on](VotingReputationClientV3.md#on)
- [once](VotingReputationClientV3.md#once)
- [populateTransaction](VotingReputationClientV3.md#populatetransaction)
- [provider](VotingReputationClientV3.md#provider)
- [removeListener](VotingReputationClientV3.md#removelistener)
- [resolvedAddress](VotingReputationClientV3.md#resolvedaddress)
- [signer](VotingReputationClientV3.md#signer)
- [votingReputationEvents](VotingReputationClientV3.md#votingreputationevents)

### Methods

- [\_checkRunningEvents](VotingReputationClientV3.md#_checkrunningevents)
- [\_deployed](VotingReputationClientV3.md#_deployed)
- [\_wrapEvent](VotingReputationClientV3.md#_wrapevent)
- [attach](VotingReputationClientV3.md#attach)
- [authority](VotingReputationClientV3.md#authority)
- [claimReward](VotingReputationClientV3.md#claimreward)
- [claimRewardWithProofs](VotingReputationClientV3.md#claimrewardwithproofs)
- [connect](VotingReputationClientV3.md#connect)
- [createClaimDelayAction](VotingReputationClientV3.md#createclaimdelayaction)
- [createDomainMotion](VotingReputationClientV3.md#createdomainmotion)
- [createDomainMotionWithProofs](VotingReputationClientV3.md#createdomainmotionwithproofs)
- [createMotion](VotingReputationClientV3.md#createmotion)
- [createMotionWithProofs](VotingReputationClientV3.md#createmotionwithproofs)
- [createRootMotion](VotingReputationClientV3.md#createrootmotion)
- [deployed](VotingReputationClientV3.md#deployed)
- [deprecate](VotingReputationClientV3.md#deprecate)
- [emit](VotingReputationClientV3.md#emit)
- [escalateMotion](VotingReputationClientV3.md#escalatemotion)
- [escalateMotionWithProofs](VotingReputationClientV3.md#escalatemotionwithproofs)
- [failingExecutionAllowed](VotingReputationClientV3.md#failingexecutionallowed)
- [fallback](VotingReputationClientV3.md#fallback)
- [finalizeMotion](VotingReputationClientV3.md#finalizemotion)
- [finishUpgrade](VotingReputationClientV3.md#finishupgrade)
- [getCapabilityRoles](VotingReputationClientV3.md#getcapabilityroles)
- [getColony](VotingReputationClientV3.md#getcolony)
- [getDeprecated](VotingReputationClientV3.md#getdeprecated)
- [getEscalationPeriod](VotingReputationClientV3.md#getescalationperiod)
- [getExpenditureMotionCount](VotingReputationClientV3.md#getexpendituremotioncount)
- [getExpenditurePastVote](VotingReputationClientV3.md#getexpenditurepastvote)
- [getMaxVoteFraction](VotingReputationClientV3.md#getmaxvotefraction)
- [getMotion](VotingReputationClientV3.md#getmotion)
- [getMotionCount](VotingReputationClientV3.md#getmotioncount)
- [getMotionState](VotingReputationClientV3.md#getmotionstate)
- [getRevealPeriod](VotingReputationClientV3.md#getrevealperiod)
- [getStake](VotingReputationClientV3.md#getstake)
- [getStakePeriod](VotingReputationClientV3.md#getstakeperiod)
- [getStakerReward](VotingReputationClientV3.md#getstakerreward)
- [getSubmitPeriod](VotingReputationClientV3.md#getsubmitperiod)
- [getTotalStakeFraction](VotingReputationClientV3.md#gettotalstakefraction)
- [getUserMinStakeFraction](VotingReputationClientV3.md#getuserminstakefraction)
- [getVoterReward](VotingReputationClientV3.md#getvoterreward)
- [getVoterRewardFraction](VotingReputationClientV3.md#getvoterrewardfraction)
- [getVoterRewardRange](VotingReputationClientV3.md#getvoterrewardrange)
- [identifier](VotingReputationClientV3.md#identifier)
- [initialise](VotingReputationClientV3.md#initialise)
- [install](VotingReputationClientV3.md#install)
- [listenerCount](VotingReputationClientV3.md#listenercount)
- [listeners](VotingReputationClientV3.md#listeners)
- [owner](VotingReputationClientV3.md#owner)
- [queryFilter](VotingReputationClientV3.md#queryfilter)
- [removeAllListeners](VotingReputationClientV3.md#removealllisteners)
- [revealVote](VotingReputationClientV3.md#revealvote)
- [setAuthority](VotingReputationClientV3.md#setauthority)
- [setOwner](VotingReputationClientV3.md#setowner)
- [stakeMotion](VotingReputationClientV3.md#stakemotion)
- [stakeMotionWithProofs](VotingReputationClientV3.md#stakemotionwithproofs)
- [submitVote](VotingReputationClientV3.md#submitvote)
- [uninstall](VotingReputationClientV3.md#uninstall)
- [version](VotingReputationClientV3.md#version)
...
• **off**: `OnEvent`<[`VotingReputationClientV3`](VotingReputationClientV3.md)\>
...
• **on**: `OnEvent`<[`VotingReputationClientV3`](VotingReputationClientV3.md)\>
...
• **once**: `OnEvent`<[`VotingReputationClientV3`](VotingReputationClientV3.md)\>
...
• **removeListener**: `OnEvent`<[`VotingReputationClientV3`](VotingReputationClientV3.md)\>
...
▸ **attach**(`addressOrName`): [`VotingReputationClientV3`](VotingReputationClientV3.md)
...
[`VotingReputationClientV3`](VotingReputationClientV3.md)
...
Same as [claimReward](VotingReputationClientV3.md#claimreward), but let colonyJS figure out the permission proofs for you.
...
▸ **connect**(`signerOrProvider`): [`VotingReputationClientV3`](VotingReputationClientV3.md)
...
Same as [createDomainMotion](VotingReputationClientV3.md#createdomainmotion), but let colonyJS figure out the permission proofs for you.
Always prefer this method, except when you have good reason not to.
...
Same as [createMotion](VotingReputationClientV3.md#createmotion), but let colonyJS figure out the permission proofs for you.
Always prefer this method, except when you have good reason not to.
...
▸ **deployed**(): `Promise`<[`VotingReputationClientV3`](VotingReputationClientV3.md)\>

#### Returns

`Promise`<[`VotingReputationClientV3`](VotingReputationClientV3.md)\>
...
Same as [escalateMotion](VotingReputationClientV3.md#escalatemotion), but let colonyJS figure out the permission proofs for you.
Always prefer this method, except when you have good reason not to.
...
▸ **removeAllListeners**<`TEvent`\>(`eventFilter`): [`VotingReputationClientV3`](VotingReputationClientV3.md)
...
▸ **removeAllListeners**(`eventName?`): [`VotingReputationClientV3`](VotingReputationClientV3.md)
...
Same as [stakeMotion](VotingReputationClientV3.md#stakemotion), but let colonyJS figure out the permission proofs for you.
Always prefer this method, except when you have good reason not to.

[ColonyJS](../README.md) / [Exports](../modules.md) / ColonyClientV4
...
- [\_deployedPromise](ColonyClientV4.md#_deployedpromise)
- [\_runningEvents](ColonyClientV4.md#_runningevents)
- [\_wrappedEmits](ColonyClientV4.md#_wrappedemits)
- [address](ColonyClientV4.md#address)
- [callStatic](ColonyClientV4.md#callstatic)
- [clientType](ColonyClientV4.md#clienttype)
- [clientVersion](ColonyClientV4.md#clientversion)
- [colonyEvents](ColonyClientV4.md#colonyevents)
- [deployTransaction](ColonyClientV4.md#deploytransaction)
- [estimateGas](ColonyClientV4.md#estimategas)
- [filters](ColonyClientV4.md#filters)
- [functions](ColonyClientV4.md#functions)
- [interface](ColonyClientV4.md#interface)
- [networkClient](ColonyClientV4.md#networkclient)
- [off](ColonyClientV4.md#off)
- [on](ColonyClientV4.md#on)
- [once](ColonyClientV4.md#once)
- [populateTransaction](ColonyClientV4.md#populatetransaction)
- [provider](ColonyClientV4.md#provider)
- [removeListener](ColonyClientV4.md#removelistener)
- [resolvedAddress](ColonyClientV4.md#resolvedaddress)
- [signer](ColonyClientV4.md#signer)
- [tokenClient](ColonyClientV4.md#tokenclient)

### Methods

- [\_checkRunningEvents](ColonyClientV4.md#_checkrunningevents)
- [\_deployed](ColonyClientV4.md#_deployed)
- [\_wrapEvent](ColonyClientV4.md#_wrapevent)
- [addDomain](ColonyClientV4.md#adddomain)
- [addDomainWithProofs](ColonyClientV4.md#adddomainwithproofs)
- [addPayment](ColonyClientV4.md#addpayment)
- [addPaymentWithProofs](ColonyClientV4.md#addpaymentwithproofs)
- [approveExitRecovery](ColonyClientV4.md#approveexitrecovery)
- [attach](ColonyClientV4.md#attach)
- [authority](ColonyClientV4.md#authority)
- [bootstrapColony](ColonyClientV4.md#bootstrapcolony)
- [cancelExpenditure](ColonyClientV4.md#cancelexpenditure)
- [cancelTask](ColonyClientV4.md#canceltask)
- [checkNotAdditionalProtectedVariable](ColonyClientV4.md#checknotadditionalprotectedvariable)
- [claimColonyFunds](ColonyClientV4.md#claimcolonyfunds)
- [claimExpenditurePayout](ColonyClientV4.md#claimexpenditurepayout)
- [claimPayment](ColonyClientV4.md#claimpayment)
- [claimRewardPayout](ColonyClientV4.md#claimrewardpayout)
- [claimTaskPayout](ColonyClientV4.md#claimtaskpayout)
- [completeTask](ColonyClientV4.md#completetask)
- [connect](ColonyClientV4.md#connect)
- [deployed](ColonyClientV4.md#deployed)
- [emit](ColonyClientV4.md#emit)
- [enterRecoveryMode](ColonyClientV4.md#enterrecoverymode)
- [executeTaskChange](ColonyClientV4.md#executetaskchange)
- [executeTaskRoleAssignment](ColonyClientV4.md#executetaskroleassignment)
- [exitRecoveryMode](ColonyClientV4.md#exitrecoverymode)
- [fallback](ColonyClientV4.md#fallback)
- [finalizeExpenditure](ColonyClientV4.md#finalizeexpenditure)
- [finalizePayment](ColonyClientV4.md#finalizepayment)
- [finalizePaymentWithProofs](ColonyClientV4.md#finalizepaymentwithproofs)
- [finalizeRewardPayout](ColonyClientV4.md#finalizerewardpayout)
- [finalizeTask](ColonyClientV4.md#finalizetask)
- [finishUpgrade](ColonyClientV4.md#finishupgrade)
- [generateSecret](ColonyClientV4.md#generatesecret)
- [getColonyNetwork](ColonyClientV4.md#getcolonynetwork)
- [getDomain](ColonyClientV4.md#getdomain)
- [getDomainCount](ColonyClientV4.md#getdomaincount)
- [getExpenditure](ColonyClientV4.md#getexpenditure)
- [getExpenditureCount](ColonyClientV4.md#getexpenditurecount)
- [getExpenditureSlot](ColonyClientV4.md#getexpenditureslot)
- [getExpenditureSlotPayout](ColonyClientV4.md#getexpenditureslotpayout)
- [getExtensionClient](ColonyClientV4.md#getextensionclient)
- [getFundingPot](ColonyClientV4.md#getfundingpot)
- [getFundingPotBalance](ColonyClientV4.md#getfundingpotbalance)
- [getFundingPotCount](ColonyClientV4.md#getfundingpotcount)
- [getFundingPotPayout](ColonyClientV4.md#getfundingpotpayout)
- [getMembersReputation](ColonyClientV4.md#getmembersreputation)
- [getNonRewardPotsTotal](ColonyClientV4.md#getnonrewardpotstotal)
- [getPayment](ColonyClientV4.md#getpayment)
- [getPaymentCount](ColonyClientV4.md#getpaymentcount)
- [getReputation](ColonyClientV4.md#getreputation)
- [getReputationAcrossDomains](ColonyClientV4.md#getreputationacrossdomains)
- [getReputationWithoutProofs](ColonyClientV4.md#getreputationwithoutproofs)
- [getRewardInverse](ColonyClientV4.md#getrewardinverse)
- [getRewardPayoutInfo](ColonyClientV4.md#getrewardpayoutinfo)
- [getTask](ColonyClientV4.md#gettask)
- [getTaskChangeNonce](ColonyClientV4.md#gettaskchangenonce)
- [getTaskCount](ColonyClientV4.md#gettaskcount)
- [getTaskPayout](ColonyClientV4.md#gettaskpayout)
- [getTaskRole](ColonyClientV4.md#gettaskrole)
- [getTaskWorkRatingSecret](ColonyClientV4.md#gettaskworkratingsecret)
- [getTaskWorkRatingSecretsInfo](ColonyClientV4.md#gettaskworkratingsecretsinfo)
- [getToken](ColonyClientV4.md#gettoken)
- [getUserRoles](ColonyClientV4.md#getuserroles)
- [hasInheritedUserRole](ColonyClientV4.md#hasinheriteduserrole)
- [hasInheritedUserRoleWithProofs](ColonyClientV4.md#hasinheriteduserrolewithproofs)
- [hasUserRole](ColonyClientV4.md#hasuserrole)
- [initialiseColony](ColonyClientV4.md#initialisecolony)
- [isInRecoveryMode](ColonyClientV4.md#isinrecoverymode)
- [listenerCount](ColonyClientV4.md#listenercount)
- [listeners](ColonyClientV4.md#listeners)
- [makeExpenditure](ColonyClientV4.md#makeexpenditure)
- [makeExpenditureWithProofs](ColonyClientV4.md#makeexpenditurewithproofs)
- [makeTask](ColonyClientV4.md#maketask)
- [makeTaskWithProofs](ColonyClientV4.md#maketaskwithproofs)
- [mintTokens](ColonyClientV4.md#minttokens)
- [moveFundsBetweenPots](ColonyClientV4.md#movefundsbetweenpots)
- [moveFundsBetweenPotsWithProofs](ColonyClientV4.md#movefundsbetweenpotswithproofs)
- [numRecoveryRoles](ColonyClientV4.md#numrecoveryroles)
- [owner](ColonyClientV4.md#owner)
- [queryFilter](ColonyClientV4.md#queryfilter)
- [registerColonyLabel](ColonyClientV4.md#registercolonylabel)
- [removeAllListeners](ColonyClientV4.md#removealllisteners)
- [removeRecoveryRole](ColonyClientV4.md#removerecoveryrole)
- [removeTaskEvaluatorRole](ColonyClientV4.md#removetaskevaluatorrole)
- [removeTaskWorkerRole](ColonyClientV4.md#removetaskworkerrole)
- [revealTaskWorkRating](ColonyClientV4.md#revealtaskworkrating)
- [setAdministrationRole](ColonyClientV4.md#setadministrationrole)
- [setAdministrationRoleWithProofs](ColonyClientV4.md#setadministrationrolewithproofs)
- [setAllTaskPayouts](ColonyClientV4.md#setalltaskpayouts)
- [setArbitrationRole](ColonyClientV4.md#setarbitrationrole)
- [setArbitrationRoleWithProofs](ColonyClientV4.md#setarbitrationrolewithproofs)
- [setArchitectureRole](ColonyClientV4.md#setarchitecturerole)
- [setArchitectureRoleWithProofs](ColonyClientV4.md#setarchitecturerolewithproofs)
- [setExpenditureClaimDelay](ColonyClientV4.md#setexpenditureclaimdelay)
- [setExpenditureClaimDelayWithProofs](ColonyClientV4.md#setexpenditureclaimdelaywithproofs)
- [setExpenditurePayout](ColonyClientV4.md#setexpenditurepayout)
- [setExpenditurePayoutModifier](ColonyClientV4.md#setexpenditurepayoutmodifier)
- [setExpenditurePayoutModifierWithProofs](ColonyClientV4.md#setexpenditurepayoutmodifierwithproofs)
- [setExpenditureRecipient](ColonyClientV4.md#setexpenditurerecipient)
- [setExpenditureSkill](ColonyClientV4.md#setexpenditureskill)
- [setFundingRole](ColonyClientV4.md#setfundingrole)
- [setFundingRoleWithProofs](ColonyClientV4.md#setfundingrolewithproofs)
- [setPaymentPayout](ColonyClientV4.md#setpaymentpayout)
- [setPaymentPayoutWithProofs](ColonyClientV4.md#setpaymentpayoutwithproofs)
- [setPaymentRecipient](ColonyClientV4.md#setpaymentrecipient)
- [setPaymentRecipientWithProofs](ColonyClientV4.md#setpaymentrecipientwithproofs)
- [setPaymentSkill](ColonyClientV4.md#setpaymentskill)
- [setPaymentSkillWithProofs](ColonyClientV4.md#setpaymentskillwithproofs)
- [setRecoveryRole](ColonyClientV4.md#setrecoveryrole)
- [setRewardInverse](ColonyClientV4.md#setrewardinverse)
- [setRootRole](ColonyClientV4.md#setrootrole)
- [setStorageSlotRecovery](ColonyClientV4.md#setstorageslotrecovery)
- [setTaskBrief](ColonyClientV4.md#settaskbrief)
- [setTaskDueDate](ColonyClientV4.md#settaskduedate)
- [setTaskEvaluatorPayout](ColonyClientV4.md#settaskevaluatorpayout)
- [setTaskEvaluatorRole](ColonyClientV4.md#settaskevaluatorrole)
- [setTaskManagerPayout](ColonyClientV4.md#settaskmanagerpayout)
- [setTaskManagerRole](ColonyClientV4.md#settaskmanagerrole)
- [setTaskSkill](ColonyClientV4.md#settaskskill)
- [setTaskWorkerPayout](ColonyClientV4.md#settaskworkerpayout)
- [setTaskWorkerRole](ColonyClientV4.md#settaskworkerrole)
- [startNextRewardPayout](ColonyClientV4.md#startnextrewardpayout)
- [submitTaskDeliverable](ColonyClientV4.md#submittaskdeliverable)
- [submitTaskDeliverableAndRating](ColonyClientV4.md#submittaskdeliverableandrating)
- [submitTaskWorkRating](ColonyClientV4.md#submittaskworkrating)
- [transferExpenditure](ColonyClientV4.md#transferexpenditure)
- [transferExpenditureViaArbitration](ColonyClientV4.md#transferexpenditureviaarbitration)
- [transferExpenditureViaArbitrationWithProofs](ColonyClientV4.md#transferexpenditureviaarbitrationwithproofs)
- [updateColonyOrbitDB](ColonyClientV4.md#updatecolonyorbitdb)
- [upgrade](ColonyClientV4.md#upgrade)
- [verifyReputationProof](ColonyClientV4.md#verifyreputationproof)
- [version](ColonyClientV4.md#version)
...
| `getExpenditure` | (`_id`: `BigNumberish`, `overrides?`: `CallOverrides`) => `Promise`<[`number`, `string`, `BigNumber`, `BigNumber`, `BigNumber`] & { `domainId`: `BigNumber` ; `finalizedTimestamp`: `BigNumber` ; `fundingPotId`: `BigNumber` ; `owner`: `string` ; `status`: `number`  }\> |
| `getExpenditureCount` | (`overrides?`: `CallOverrides`) => `Promise`<`BigNumber`\> |
| `getExpenditureSlot` | (`_id`: `BigNumberish`, `_slot`: `BigNumberish`, `overrides?`: `CallOverrides`) => `Promise`<[`string`, `BigNumber`, `BigNumber`, `BigNumber`[]] & { `claimDelay`: `BigNumber` ; `payoutModifier`: `BigNumber` ; `recipient`: `string` ; `skills`: `BigNumber`[]  }\> |
...
| `getRewardPayoutInfo` | (`_payoutId`: `BigNumberish`, `overrides?`: `CallOverrides`) => `Promise`<[`string`, `BigNumber`, `BigNumber`, `BigNumber`, `string`, `BigNumber`, `BigNumber`, `boolean`] & { `amount`: `BigNumber` ; `amountRemaining`: `BigNumber` ; `blockTimestamp`: `BigNumber` ; `colonyWideReputation`: `BigNumber` ; `finalized`: `boolean` ; `reputationState`: `string` ; `tokenAddress`: `string` ; `totalTokens`: `BigNumber`  }\> |
...
| `ExpenditureCancelled` | (`expenditureId?`: ``null`` \| `BigNumberish`) => `ExpenditureCancelledEventFilter` |
| `ExpenditureCancelled(uint256)` | (`expenditureId?`: ``null`` \| `BigNumberish`) => `ExpenditureCancelledEventFilter` |
| `ExpenditureFinalized` | (`expenditureId?`: ``null`` \| `BigNumberish`) => `ExpenditureFinalizedEventFilter` |
| `ExpenditureFinalized(uint256)` | (`expenditureId?`: ``null`` \| `BigNumberish`) => `ExpenditureFinalizedEventFilter` |
| `ExpenditurePayoutSet` | (`expenditureId?`: ``null`` \| `BigNumberish`, `slot?`: ``null`` \| `BigNumberish`, `token?`: ``null`` \| `string`, `amount?`: ``null``) => `ExpenditurePayoutSetEventFilter` |
| `ExpenditurePayoutSet(uint256,uint256,address,uint256)` | (`expenditureId?`: ``null`` \| `BigNumberish`, `slot?`: ``null`` \| `BigNumberish`, `token?`: ``null`` \| `string`, `amount?`: ``null``) => `ExpenditurePayoutSetEventFilter` |
| `ExpenditureRecipientSet` | (`expenditureId?`: ``null`` \| `BigNumberish`, `slot?`: ``null`` \| `BigNumberish`, `recipient?`: ``null`` \| `string`) => `ExpenditureRecipientSetEventFilter` |
| `ExpenditureRecipientSet(uint256,uint256,address)` | (`expenditureId?`: ``null`` \| `BigNumberish`, `slot?`: ``null`` \| `BigNumberish`, `recipient?`: ``null`` \| `string`) => `ExpenditureRecipientSetEventFilter` |
| `ExpenditureSkillSet` | (`expenditureId?`: ``null`` \| `BigNumberish`, `slot?`: ``null`` \| `BigNumberish`, `skillId?`: ``null`` \| `BigNumberish`) => `ExpenditureSkillSetEventFilter` |
| `ExpenditureSkillSet(uint256,uint256,uint256)` | (`expenditureId?`: ``null`` \| `BigNumberish`, `slot?`: ``null`` \| `BigNumberish`, `skillId?`: ``null`` \| `BigNumberish`) => `ExpenditureSkillSetEventFilter` |
| `ExpenditureTransferred` | (`expenditureId?`: ``null`` \| `BigNumberish`, `owner?`: ``null`` \| `string`) => `ExpenditureTransferredEventFilter` |
| `ExpenditureTransferred(uint256,address)` | (`expenditureId?`: ``null`` \| `BigNumberish`, `owner?`: ``null`` \| `string`) => `ExpenditureTransferredEventFilter` |
...
| `getExpenditure` | (`_id`: `BigNumberish`, `overrides?`: `CallOverrides`) => `Promise`<[[`number`, `string`, `BigNumber`, `BigNumber`, `BigNumber`] & { `domainId`: `BigNumber` ; `finalizedTimestamp`: `BigNumber` ; `fundingPotId`: `BigNumber` ; `owner`: `string` ; `status`: `number`  }] & { `expenditure`: [`number`, `string`, `BigNumber`, `BigNumber`, `BigNumber`] & { `domainId`: `BigNumber` ; `finalizedTimestamp`: `BigNumber` ; `fundingPotId`: `BigNumber` ; `owner`: `string` ; `status`: `number`  }  }\> |
| `getExpenditureCount` | (`overrides?`: `CallOverrides`) => `Promise`<[`BigNumber`] & { `count`: `BigNumber`  }\> |
| `getExpenditureSlot` | (`_id`: `BigNumberish`, `_slot`: `BigNumberish`, `overrides?`: `CallOverrides`) => `Promise`<[[`string`, `BigNumber`, `BigNumber`, `BigNumber`[]] & { `claimDelay`: `BigNumber` ; `payoutModifier`: `BigNumber` ; `recipient`: `string` ; `skills`: `BigNumber`[]  }] & { `expenditureSlot`: [`string`, `BigNumber`, `BigNumber`, `BigNumber`[]] & { `claimDelay`: `BigNumber` ; `payoutModifier`: `BigNumber` ; `recipient`: `string` ; `skills`: `BigNumber`[]  }  }\> |
...
| `getRewardPayoutInfo` | (`_payoutId`: `BigNumberish`, `overrides?`: `CallOverrides`) => `Promise`<[[`string`, `BigNumber`, `BigNumber`, `BigNumber`, `string`, `BigNumber`, `BigNumber`, `boolean`] & { `amount`: `BigNumber` ; `amountRemaining`: `BigNumber` ; `blockTimestamp`: `BigNumber` ; `colonyWideReputation`: `BigNumber` ; `finalized`: `boolean` ; `reputationState`: `string` ; `tokenAddress`: `string` ; `totalTokens`: `BigNumber`  }] & { `rewardPayoutCycle`: [`string`, `BigNumber`, `BigNumber`, `BigNumber`, `string`, `BigNumber`, `BigNumber`, `boolean`] & { `amount`: `BigNumber` ; `amountRemaining`: `BigNumber` ; `blockTimestamp`: `BigNumber` ; `colonyWideReputation`: `BigNumber` ; `finalized`: `boolean` ; `reputationState`: `string` ; `tokenAddress`: `string` ; `totalTokens`: `BigNumber`  }  }\> |
| `getTask` | (`_id`: `BigNumberish`, `overrides?`: `CallOverrides`) => `Promise`<[`string`, `string`, `number`, `BigNumber`, `BigNumber`, `BigNumber`, `BigNumber`, `BigNumber`[]] & { `completionTimestamp`: `BigNumber` ; `deliverableHash`: `string` ; `domainId`: `BigNumber` ; `dueDate`: `BigNumber` ; `fundingPotId`: `BigNumber` ; `skillIds`: `BigNumber`[] ; `specificationHash`: `string` ; `status`: `number`  }\> |
...
| `getUserRoles` | (`who`: `string`, `where`: `BigNumberish`, `overrides?`: `CallOverrides`) => `Promise`<[`string`] & { `roles`: `string`  }\> |

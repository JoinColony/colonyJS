...
import { ACTIVE_TASK_STATUS } from '../../packages/colony-js-client';

const taskDescription = 'Integration Tests Task';

test('Get a Task that exists in the Colony', async t => {
  /*
  ...
  t.is(existingTask, Object);
  t.true(Object.hasOwnProperty.call(existingTask, 'id'));
  /*

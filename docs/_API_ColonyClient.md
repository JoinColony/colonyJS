...
|Return value|Type|Description|
|---|---|---|
|secret|undefined|keccak256 hash of joint Salt and Value.|
...
|Return value|Type|Description|
|---|---|---|
|secret|undefined|the hashed rating (equivalent to the output of `keccak256(_salt, _rating)`).|
...
|secret|undefined|hidden work rating, generated as the output of `generateSecret(_salt, _rating)`, where `_rating` is a score from 1-3.|

...
▸ **deployTokenAuthority**(`tokenAddress`, `allowedToTransfer`, `overrides?`): `Promise`<`ContractTransaction`\>
...
| :------ | :------ | :------ |
| `tokenAddress` | `string` | The token to install the token authority for |

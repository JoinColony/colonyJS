[ColonyJS](../README.md) / [Exports](../modules.md) / ColonyClientV3
...
- [claimTaskPayout](ColonyClientV3.md#claimtaskpayout)
...
- [setArbitrationRole](ColonyClientV3.md#setarbitrationrole)
...
▸ **connect**(`signerOrProvider`): [`ColonyClientV3`](ColonyClientV3.md)
...
Same as [makeTask](ColonyClientV3.md#maketask), but let colonyJS figure out the permission proofs for you.
Always prefer this method, except when you have good reason not to.
...
▸ **removeAllListeners**<`TEvent`\>(`eventFilter`): [`ColonyClientV3`](ColonyClientV3.md)
...
▸ **removeAllListeners**(`eventName?`): [`ColonyClientV3`](ColonyClientV3.md)
...
Same as [setAdministrationRole](ColonyClientV3.md#setadministrationrole), but let colonyJS figure out the permission proofs for you.
Always prefer this method, except when you have good reason not to.
...
Same as [setArbitrationRole](ColonyClientV3.md#setarbitrationrole), but let colonyJS figure out the permission proofs for you.
Always prefer this method, except when you have good reason not to.
...
Same as [setArchitectureRole](ColonyClientV3.md#setarchitecturerole), but let colonyJS figure out the permission proofs for you.
Always prefer this method, except when you have good reason not to.
...
Same as [setFundingRole](ColonyClientV3.md#setfundingrole), but let colonyJS figure out the permission proofs for you.
Always prefer this method, except when you have good reason not to.
...
Same as [setPaymentPayout](ColonyClientV3.md#setpaymentpayout), but let colonyJS figure out the permission proofs for you.
Always prefer this method, except when you have good reason not to.
...
Same as [setPaymentRecipient](ColonyClientV3.md#setpaymentrecipient), but let colonyJS figure out the permission proofs for you.
Always prefer this method, except when you have good reason not to.
...
Same as [setPaymentSkill](ColonyClientV3.md#setpaymentskill), but let colonyJS figure out the permission proofs for you.
Always prefer this method, except when you have good reason not to.

[ColonyJS](../README.md) / [Exports](../modules.md) / CoinMachineClientV3
...
- [\_deployedPromise](CoinMachineClientV3.md#_deployedpromise)
- [\_runningEvents](CoinMachineClientV3.md#_runningevents)
- [\_wrappedEmits](CoinMachineClientV3.md#_wrappedemits)
- [address](CoinMachineClientV3.md#address)
- [callStatic](CoinMachineClientV3.md#callstatic)
- [clientType](CoinMachineClientV3.md#clienttype)
- [clientVersion](CoinMachineClientV3.md#clientversion)
- [coinMachineEvents](CoinMachineClientV3.md#coinmachineevents)
- [colonyClient](CoinMachineClientV3.md#colonyclient)
- [deployTransaction](CoinMachineClientV3.md#deploytransaction)
- [estimateGas](CoinMachineClientV3.md#estimategas)
- [filters](CoinMachineClientV3.md#filters)
- [functions](CoinMachineClientV3.md#functions)
- [interface](CoinMachineClientV3.md#interface)
- [off](CoinMachineClientV3.md#off)
- [on](CoinMachineClientV3.md#on)
- [once](CoinMachineClientV3.md#once)
- [populateTransaction](CoinMachineClientV3.md#populatetransaction)
- [provider](CoinMachineClientV3.md#provider)
- [removeListener](CoinMachineClientV3.md#removelistener)
- [resolvedAddress](CoinMachineClientV3.md#resolvedaddress)
- [signer](CoinMachineClientV3.md#signer)

### Methods

- [\_checkRunningEvents](CoinMachineClientV3.md#_checkrunningevents)
- [\_deployed](CoinMachineClientV3.md#_deployed)
- [\_wrapEvent](CoinMachineClientV3.md#_wrapevent)
- [attach](CoinMachineClientV3.md#attach)
- [authority](CoinMachineClientV3.md#authority)
- [buyTokens](CoinMachineClientV3.md#buytokens)
- [connect](CoinMachineClientV3.md#connect)
- [deployed](CoinMachineClientV3.md#deployed)
- [deprecate](CoinMachineClientV3.md#deprecate)
- [emit](CoinMachineClientV3.md#emit)
- [fallback](CoinMachineClientV3.md#fallback)
- [finishUpgrade](CoinMachineClientV3.md#finishupgrade)
- [getActiveIntake](CoinMachineClientV3.md#getactiveintake)
- [getActivePeriod](CoinMachineClientV3.md#getactiveperiod)
- [getActiveSold](CoinMachineClientV3.md#getactivesold)
- [getCapabilityRoles](CoinMachineClientV3.md#getcapabilityroles)
- [getColony](CoinMachineClientV3.md#getcolony)
- [getCurrentPrice](CoinMachineClientV3.md#getcurrentprice)
- [getDeprecated](CoinMachineClientV3.md#getdeprecated)
- [getEMAIntake](CoinMachineClientV3.md#getemaintake)
- [getEvolvePrice](CoinMachineClientV3.md#getevolveprice)
- [getMaxPerPeriod](CoinMachineClientV3.md#getmaxperperiod)
- [getMaxPurchase](CoinMachineClientV3.md#getmaxpurchase)
- [getPeriodLength](CoinMachineClientV3.md#getperiodlength)
- [getPurchaseToken](CoinMachineClientV3.md#getpurchasetoken)
- [getSellableTokens](CoinMachineClientV3.md#getsellabletokens)
- [getTargetPerPeriod](CoinMachineClientV3.md#gettargetperperiod)
- [getToken](CoinMachineClientV3.md#gettoken)
- [getTokenBalance](CoinMachineClientV3.md#gettokenbalance)
- [getUserLimit](CoinMachineClientV3.md#getuserlimit)
- [getWhitelist](CoinMachineClientV3.md#getwhitelist)
- [getWindowSize](CoinMachineClientV3.md#getwindowsize)
- [identifier](CoinMachineClientV3.md#identifier)
- [initialise](CoinMachineClientV3.md#initialise)
- [install](CoinMachineClientV3.md#install)
- [listenerCount](CoinMachineClientV3.md#listenercount)
- [listeners](CoinMachineClientV3.md#listeners)
- [owner](CoinMachineClientV3.md#owner)
- [queryFilter](CoinMachineClientV3.md#queryfilter)
- [removeAllListeners](CoinMachineClientV3.md#removealllisteners)
- [setAuthority](CoinMachineClientV3.md#setauthority)
- [setOwner](CoinMachineClientV3.md#setowner)
- [setWhitelist](CoinMachineClientV3.md#setwhitelist)
- [uninstall](CoinMachineClientV3.md#uninstall)
- [updatePeriod](CoinMachineClientV3.md#updateperiod)
- [version](CoinMachineClientV3.md#version)
...
• **off**: `OnEvent`<[`CoinMachineClientV3`](CoinMachineClientV3.md)\>
...
• **on**: `OnEvent`<[`CoinMachineClientV3`](CoinMachineClientV3.md)\>
...
• **once**: `OnEvent`<[`CoinMachineClientV3`](CoinMachineClientV3.md)\>
...
• **removeListener**: `OnEvent`<[`CoinMachineClientV3`](CoinMachineClientV3.md)\>
...
▸ **attach**(`addressOrName`): [`CoinMachineClientV3`](CoinMachineClientV3.md)
...
[`CoinMachineClientV3`](CoinMachineClientV3.md)
...
▸ **connect**(`signerOrProvider`): [`CoinMachineClientV3`](CoinMachineClientV3.md)
...
▸ **deployed**(): `Promise`<[`CoinMachineClientV3`](CoinMachineClientV3.md)\>

#### Returns

`Promise`<[`CoinMachineClientV3`](CoinMachineClientV3.md)\>
...
▸ **removeAllListeners**<`TEvent`\>(`eventFilter`): [`CoinMachineClientV3`](CoinMachineClientV3.md)
...
▸ **removeAllListeners**(`eventName?`): [`CoinMachineClientV3`](CoinMachineClientV3.md)
